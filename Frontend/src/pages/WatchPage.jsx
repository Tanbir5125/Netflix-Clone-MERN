            ...
            <div className="mx-auto container px-4 h-full">
                ...
                {trailer.length > 0 && (
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button
                            className={`bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${currentTrailerIdx === trailer.length - 1
                ...
                <div className="aspect-video mb-8 p-2 sm:px-10 md:px-14">
                    {trailer.length > 0 && (
                        <ReactPlayer
                            controls={true}
                            width={"100%"}
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-20 max-w-6xl mx-auto">
                    <div className="mb:4 md:mb-0">
                        ...
                        <p className="mt-2 text-lg">
                            ...
                            |{" "}
                            {content?.adult ? (
                                <span className="text-red-600">R-rated</span>
                            ) : (
